...
import (
	...
	"github.com/sunnogo/sys/windows/svc"
	"github.com/sunnogo/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/sunnogo/sys/windows/svc/example").CombinedOutput()
	if err != nil {
